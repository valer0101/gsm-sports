...
export class RankingUniqueAddWeightCategory1775200000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Create new unique constraint including weightCategory so one athlete
        // can hold rankings in multiple weight divisions simultaneously
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "UQ_e611ca7f96b0d1e79b3b68dabc9" ON "ranking_entries" ("athlete_id", "sport_id", "season", "hand", "gender", "weightCategory")`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX IF EXISTS "UQ_e611ca7f96b0d1e79b3b68dabc9"`);
