...
const NEXT_LABELS: Record<number, string> = { 1: 'Format', 2: 'Categories', 3: 'Registration' };
    ...
    <footer className="sticky bottom-0 z-30 py-3 sm:py-4 px-4 sm:px-6 bg-[var(--color-background)] border-t border-[var(--color-border)]">
      <div className="max-w-3xl mx-auto flex items-center justify-between gap-3">
        ...
        {currentStep < 4 ? (
          ...
          >
            <span className="hidden sm:inline">Next: {NEXT_LABELS[currentStep]}</span>
          ...
          >
            ...
            <span className="hidden sm:inline">{isSubmitting ? 'Creating...' : 'Create tournament'}</span>
